    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-outline-secondary btn-sm mb-2">
                        <i class="bi bi-arrow-left me-1"></i>Back to Users
                    </a>
                    <h2 class="mb-0"><?php echo e($user->name); ?></h2>
                    <p class="text-muted">User ID: #<?php echo e($user->id); ?></p>
                </div>
                <div class="btn-group">
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <span class="badge <?php echo e($user->getStatusBadgeClass()); ?> fs-6">
                ...
                <div class="card-body">
                    <div class="stat-item mb-3">
                        ...
                        <div class="fw-semibold">
                            <i class="bi bi-award text-primary me-1"></i><?php echo e(ucfirst($user->membership_type)); ?>
                    ...
                    <div class="stat-item mb-3">
                        ...
                        <div class="fw-semibold">
                            <?php if($user->getLastLogin()): ?>
                                <?php echo e($user->getLastLogin()->diffForHumans()); ?>
                    ...
                    <div class="stat-item">
                        ...
                        <div class="fw-semibold">
                            <?php if($kycSubmission): ?>
                                <?php if($kycSubmission->status === 'approved'): ?>
                                    <i class="bi bi-check-circle-fill text-success me-1"></i>Approved
                                <?php elseif($kycSubmission->status === 'rejected'): ?>
                                    <i class="bi bi-x-circle-fill text-danger me-1"></i>Rejected
                                <?php else: ?>
                                    <i class="bi bi-clock-fill text-warning me-1"></i><?php echo e(ucfirst($kycSubmission->status)); ?>
            ...
            <div class="card">
                ...
                <div class="list-group list-group-flush">
                    <?php if($kycSubmission): ?>
                        <a href="<?php echo e(route('admin.users.kyc', $user->id)); ?>" class="list-group-item list-group-item-action">
                    ...
                    <a href="mailto:<?php echo e($user->email); ?>" class="list-group-item list-group-item-action">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0 fw-semibold"><?php echo e($user->email); ?></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="text-muted small">Phone</label>
                            <p class="mb-0 fw-semibold"><?php echo e($user->phone ?? 'Not provided'); ?></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="text-muted small">Date of Birth</label>
                            <p class="mb-0 fw-semibold">
                                <?php echo e($user->date_of_birth ? \Carbon\Carbon::parse($user->date_of_birth)->format('M d, Y') : 'Not provided'); ?>
                        ...
                        <?php if($user->address): ?>
                            <div class="col-12">
                                ...
                                <p class="mb-0">
                                    ...
                                    <?php echo e($user->city); ?>, <?php echo e($user->state); ?> <?php echo e($user->postal_code); ?><br>
            ...
            <?php if($kycSubmission): ?>
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('admin.users.kyc', $user->id)); ?>" class="btn btn-sm btn-primary">
                            View Full Details
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0">
                                    <span class="badge bg-<?php echo e($kycSubmission->status === 'approved' ? 'success' : ($kycSubmission->status === 'rejected' ? 'danger' : 'warning')); ?>">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0 fw-semibold"><?php echo e($kycSubmission->submitted_at->format('M d, Y')); ?></p>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0 fw-semibold"><?php echo e(substr($kycSubmission->id_number, 0, 3) . str_repeat('*', 6) . substr($kycSubmission->id_number, -3)); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <?php $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="activity-item d-flex mb-3 pb-3 border-bottom">
                                    <div class="activity-icon me-3">
                                        <i class="<?php echo e($activity->getIconClass()); ?>" style="font-size: 1.5rem;"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1"><?php echo e($activity->getTypeLabel()); ?></h6>
                                        <p class="text-muted small mb-1"><?php echo e($activity->description); ?></p>
                                        <small class="text-muted">
                                            <i class="bi bi-clock me-1"></i><?php echo e($activity->created_at->diffForHumans()); ?>

                                            <?php if($activity->admin): ?>
                                                <span class="mx-2">•</span>
                                                <i class="bi bi-person-badge me-1"></i><?php echo e($activity->admin->user->name); ?>
        ...
        <div class="modal-content">
            <form action="<?php echo e(route('admin.users.suspend', $user->id)); ?>" method="POST">
                ...
                <div class="modal-body">
                    <p>You are about to suspend <strong><?php echo e($user->name); ?></strong>'s account.</p>
                    <div class="mb-3">
