...
<body>
    ...
    <div class="container dashboard-container">
        ...
        <div class="welcome-card">
            <h1><i class="bi bi-house-heart"></i> Welcome back, <?php echo e($user->name); ?>!</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->properties_count); ?></div>
                    <div class="stats-change text-success">
                        <i class="bi bi-arrow-up"></i> <?php echo e($stats->active_properties); ?> Active
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->getFormattedPropertyValue()); ?></div>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->getFormattedRentalIncome()); ?></div>
                    <div class="stats-change text-success">
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->getOccupancyRate()); ?>%</div>
                    <div class="stats-change text-muted">
                        <?php echo e($stats->rented_properties); ?>/<?php echo e($stats->properties_count); ?> Rented
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->maintenance_tickets); ?></div>
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->service_apartment_enrollments); ?></div>
                    <div class="stats-change text-success">
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->getFormattedMonthlyRevenue()); ?></div>
                    <div class="stats-change text-success">
...
<?php /**PATH C:\xampp1\htdocs\new 360 Project\resources\views/dashboard/owner.blade.php ENDPATH**/ ?>