...
<div class="row g-4 mb-4">
    <div class="col-md-4">
        <div class="stats-card p-4">
            ...
            <h2 class="text-white fw-bold mb-0">₦<?php echo e(number_format(180000)); ?></h2> <!-- Placeholder/Real Data -->
        </div>
    </div>
    <div class="col-md-4">
        <div class="stats-card p-4">
    ...
    <div class="table-responsive">
        <table class="table earnings-table">
            ...
            <tbody>
                ...
                <tr>
                    <td class="ps-3 fw-bold"><?php echo e($transaction->property->title ?? 'N/A'); ?></td>
                    <td><span class="badge" style="background: rgba(255,255,255,0.1); color: white;">Rental Income</span></td>
                    <td class="text-success fw-bold">+₦<?php echo e(number_format($transaction->amount ?? 0)); ?></td>
                    <td><span class="badge" style="background: rgba(16, 185, 129, 0.2); color: #10B981;">Completed</span></td>
                    <td class="text-muted"><?php echo e($transaction->created_at ? $transaction->created_at->format('M d, Y') : 'Jan 01, 2026'); ?></td>
