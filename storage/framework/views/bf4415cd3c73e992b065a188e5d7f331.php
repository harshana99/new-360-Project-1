...
<?php $__env->startSection('title', 'KYC Status - 360WinEstate'); ?>
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <?php elseif($kycSubmission->requiresResubmission()): ?>
                        ...
                        <?php elseif($kycSubmission->isUnderReview()): ?>
                        ...
                        <span class="badge <?php echo e($kycSubmission->getStatusBadgeClass()); ?> fs-6 px-4 py-2">
                            <?php echo e($kycSubmission->getStatusLabel()); ?>
                    ...
                    <div class="row text-center mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <strong class="text-navy"><?php echo e($kycSubmission->id ?? 'N/A'); ?></strong>
                        </div>
                        <div class="col-md-6 mb-3">
                            <small class="text-muted d-block">Submitted</small>
                            <strong class="text-navy"><?php echo e($kycSubmission->submitted_at?->diffForHumans() ?? 'N/A'); ?></strong>
                        </div>
                        <?php if($kycSubmission->reviewed_at): ?>
                        <div class="col-md-6 mb-3">
                            <small class="text-muted d-block">Reviewed</small>
                            <strong class="text-navy"><?php echo e($kycSubmission->reviewed_at->diffForHumans()); ?></strong>
                        </div>
                        <?php endif; ?>
                        <?php if($kycSubmission->reviewer): ?>
                        <div class="col-md-6 mb-3">
                            <small class="text-muted d-block">Reviewed By</small>
                            <strong class="text-navy"><?php echo e($kycSubmission->reviewer->name); ?></strong>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php if($kycSubmission->isApproved()): ?>
                        ...
                        <div class="alert alert-info border-0 mb-4">
                            ...
                            <?php echo e($kycSubmission->admin_notes); ?>

                        </div>
                        <?php endif; ?>

                        <div class="d-grid">
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-success btn-lg">
                    ...
                    <?php elseif($kycSubmission->isRejected()): ?>
                        ...
                        <div class="d-grid gap-2">
                            <a href="<?php echo e(route('kyc.resubmit')); ?>" class="btn btn-primary btn-lg">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <div class="timeline">
                        <!-- Submitted -->
                        <div class="timeline-item <?php echo e($kycSubmission->submitted_at ? 'completed' : ''); ?>">
                            <div class="timeline-marker">
                                <i class="bi bi-check-circle-fill"></i>
                            </div>
                            <div class="timeline-content">
                                <strong>KYC Submitted</strong>
                                <?php if($kycSubmission->submitted_at): ?>
                                    <br><small class="text-muted"><?php echo e($kycSubmission->submitted_at->format('M d, Y H:i')); ?></small>
                                <?php endif; ?>
                            </div>
                        </div>

                        <!-- Under Review -->
                        <div class="timeline-item <?php echo e($kycSubmission->isUnderReview() || $kycSubmission->reviewed_at ? 'completed' : ''); ?>">
                            <div class="timeline-marker">
                                <i class="bi bi-<?php echo e($kycSubmission->isUnderReview() || $kycSubmission->reviewed_at ? 'check-circle-fill' : 'circle'); ?>"></i>
                            </div>
                            <div class="timeline-content">
                                <strong>Under Review</strong>
                                <?php if($kycSubmission->isUnderReview()): ?>
                        ...
                        <!-- Completed -->
                        <div class="timeline-item <?php echo e($kycSubmission->reviewed_at ? 'completed' : ''); ?>">
                            <div class="timeline-marker">
                                <i class="bi bi-<?php echo e($kycSubmission->reviewed_at ? 'check-circle-fill' : 'circle'); ?>"></i>
                            </div>
                            <div class="timeline-content">
                                <strong>Review Complete</strong>
                                <?php if($kycSubmission->reviewed_at): ?>
                                    <br><small class="text-muted"><?php echo e($kycSubmission->reviewed_at->format('M d, Y H:i')); ?></small>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
