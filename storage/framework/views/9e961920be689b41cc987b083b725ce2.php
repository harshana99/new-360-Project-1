...
<body>
    ...
    <div class="container dashboard-container">
        ...
        <div class="welcome-card">
            <h1><i class="bi bi-graph-up"></i> Welcome back, <?php echo e($user->name); ?>!</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->investments_count); ?></div>
                    <div class="stats-change text-success">
                        <i class="bi bi-arrow-up"></i> <?php echo e($stats->active_investments); ?> Active
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->getFormattedTotalInvested()); ?></div>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->getFormattedTotalRoi()); ?></div>
                    <div class="stats-change">
                        <span class="roi-badge roi-positive">
                            <i class="bi bi-arrow-up"></i> <?php echo e($stats->roi_percentage); ?>%
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->getFormattedWalletBalance()); ?></div>
                    <div class="stats-change text-muted">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->getFormattedPortfolioValue()); ?></div>
                    <div class="stats-change text-success">
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->projects_funded); ?></div>
                    <div class="stats-change text-muted">
                        <i class="bi bi-check-circle"></i> <?php echo e($stats->completed_projects); ?> Completed
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <div class="stats-value"><?php echo e($stats->getFormattedMonthlyReturns()); ?></div>
                    <div class="stats-change text-success">
...
<?php /**PATH C:\xampp1\htdocs\new 360 Project\resources\views/dashboard/investor.blade.php ENDPATH**/ ?>