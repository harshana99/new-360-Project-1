...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - 360WinEstate</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <?php if(auth()->user()->admin->isSuperAdmin()): ?>
        <a href="<?php echo e(route('admin.admins')); ?>" class="<?php echo e(request()->routeIs('admin.admins*') ? 'active' : ''); ?>">
        ...
        <?php if(Route::has('admin.kyc') && (auth()->user()->admin->isSuperAdmin() || auth()->user()->admin->isComplianceAdmin())): ?>
        <a href="<?php echo e(route('admin.kyc')); ?>" class="<?php echo e(request()->routeIs('admin.kyc*') ? 'active' : ''); ?>">
            <i class="bi bi-file-check me-2"></i> KYC Management
        </a>
        <?php endif; ?>
        
        <?php if(Route::has('admin.analytics')): ?>
        <a href="<?php echo e(route('admin.analytics')); ?>" class="<?php echo e(request()->routeIs('admin.analytics*') ? 'active' : ''); ?>">
    ...
    <div class="main-content">
        ...
        <div class="header d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-0 fw-bold"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h5>
            </div>
...
<?php /**PATH C:\xampp1\htdocs\new 360 Project\resources\views/layouts/admin.blade.php ENDPATH**/ ?>