...
<div class="container-fluid py-4">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-{{ $kycSubmission->status === 'approved' ? 'success' : ($kycSubmission->status === 'rejected' ? 'danger' : 'warning') }} fs-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0 fw-semibold">#{{ $kycSubmission->id }}</p>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        @if($kycSubmission->reviewed_at)
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0 fw-semibold">{{ $kycSubmission->reviewed_at->format('M d, Y h:i A') }}</p>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="text-muted small">Reviewed By</label>
                                <p class="mb-0 fw-semibold">
                                    @if($kycSubmission->reviewed_by_admin_id)
                                        Admin #{{ $kycSubmission->reviewed_by_admin_id }}
                                    @else
                                        N/A
                                    @endif
                                </p>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0 fw-semibold">
                                {{ \Carbon\Carbon::parse($kycSubmission->date_of_birth)->format('M d, Y') }}
                                <small class="text-muted">({{ \Carbon\Carbon::parse($kycSubmission->date_of_birth)->age }} years old)</small>
                            </p>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="mb-0 fw-semibold">{{ $kycSubmission->id_number }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <p class="mb-1">{{ $kycSubmission->address }}</p>
                    <p class="mb-0">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <h6>ID Document</h6>
                            @if($kycSubmission->id_image_path)
                        ...
                        <div class="col-md-6 mb-3">
                            <h6>Address Proof</h6>
                            @if($kycSubmission->address_proof_path)
                                <div class="document-preview mb-2">
                                    @if(str_ends_with($kycSubmission->address_proof_path, '.pdf'))
            ...
            <!-- Admin Feedback -->
            @if($kycSubmission->rejection_reason || $kycSubmission->admin_notes)
                <div class="card mb-4">
                    <div class="card-header">
        ...
        <div class="col-lg-4">
            <!-- Quick Actions -->
            @if($kycSubmission->status === 'submitted' || $kycSubmission->status === 'under_review')
                <div class="card mb-4">
                    <div class="card-header">
            ...
            <!-- KYC History -->
            @if($kycHistory && count($kycHistory) > 1)
                <div class="card">
                    <div class="card-header">
                        <h6 class="mb-0">Submission History</h6>
                    </div>
                    <div class="list-group list-group-flush">
                        @foreach($kycHistory as $kyc)
                            <div class="list-group-item {{ $kyc->id === $kycSubmission->id ? 'active' : '' }}">
...
<div class="modal fade" id="approveModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.kyc.approve', $kycSubmission->id) }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <p>You are about to approve the KYC submission for <strong>{{ $user->name }}</strong>.</p>
                    <div class="mb-3">
...
<div class="modal fade" id="rejectModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.kyc.reject', $kycSubmission->id) }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <p>You are about to reject the KYC submission for <strong>{{ $user->name }}</strong>.</p>
                    <div class="mb-3">
