    ...
    <div class="col-lg-8">
            ...
            <div class="col-md-6">
                ...
                <div class="stats-card d-flex flex-column justify-content-between" style="background: white;">
                    <div>
                        ...
                        <div class="value" style="color: #1E293B;">{{ $metrics->total_properties_count }}</div>
            ...
            <div class="col-md-6">
                ...
                <div class="stats-card d-flex flex-column justify-content-between" style="background: white;">
                    <div>
                        ...
                        <div class="value" style="color: #1E293B;">₦{{ number_format($metrics->total_earnings, 0) }}</div>
            ...
            <div class="col-md-6">
                ...
                <div class="stats-card d-flex flex-column justify-content-between" style="background: white;">
                    <div>
                        ...
                        <div class="value" style="color: #1E293B;">{{ $metrics->active_investments_count }}</div>
        ...
        <div class="mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('owner.properties') }}" class="text-muted text-decoration-none" style="font-size: 14px;">See All <i class="bi bi-chevron-right"></i></a>
            </div>
            ...
            @forelse($myProps as $prop)
            <div class="property-list-item">
                <div class="prop-info">
                    <img src="{{ $prop->image_url ?? 'https://via.placeholder.com/60' }}" class="prop-img" alt="Property">
                    <div class="prop-text">
                        <h4>{{ $prop->title }}</h4>
                        <p>{{ $prop->location }}</p>
                    </div>
                ...
                <div class="prop-price">
                    <h4>₦{{ number_format($prop->price, 0) }}</h4>
                    <span>{{ ucfirst($prop->status) }}</span>
                </div>
            </div>
            @empty
            <div class="text-center py-4 text-muted">
                No properties found. <a href="{{ route('owner.properties') }}" class="text-white">Add one?</a>
            </div>
            @endforelse
        </div>
    </div>
