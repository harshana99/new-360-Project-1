    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            ...
            <div class="d-flex align-items-center">
                <span class="me-3 text-muted">{{ $user->name }}</span>
    ...
    <div class="main-container" style="margin-top: 80px;">
        ...
        <div class="status-card text-center">
            ...
            <div class="status-icon">
                ...
                @elseif($user->status === 'kyc_submitted' || $user->status === 'under_review')
            ...
            <div class="status-badge">
                @if($user->status === 'membership_selected')
                    Membership Selected
                @elseif($user->status === 'kyc_submitted')
                    KYC Submitted
            ...
            @if($user->status === 'membership_selected')
                ...
                <p class="status-description">
                    You've selected <strong>{{ ucfirst($user->membership_type) }}</strong> membership. 
                ...
                <!-- CTA Button -->
                <a href="{{ route('kyc.create') }}" class="btn-kyc">
            ...
            @elseif($user->status === 'kyc_submitted')
                ...
                <a href="{{ route('kyc.status') }}" class="btn-kyc">
            ...
            @elseif($user->status === 'rejected')
                ...
                @endif
                <a href="{{ route('kyc.resubmit') }}" class="btn-kyc">
                ...
                <div class="info-row">
                    ...
                    @if($user->membership_type)
                        <div class="info-item">
                            ...
                            <div class="info-value">{{ ucfirst($user->membership_type) }}</div>
                        </div>
                    @endif
                    <div class="info-item">
