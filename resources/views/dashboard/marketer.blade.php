...
<body>
    ...
    <div class="container dashboard-container">
        ...
        <div class="welcome-card">
            <h1><i class="bi bi-rocket-takeoff"></i> Welcome back, {{ $user->name }}!</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value">{{ $stats->total_referrals }}</div>
                    <div class="stats-change text-success">
                        <i class="bi bi-arrow-up"></i> {{ $stats->this_month_referrals }} This Month
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value">{{ $stats->verified_referrals }}</div>
                    <div class="stats-change text-muted">
                        <i class="bi bi-percent"></i> {{ $stats->getVerificationRate() }}% Rate
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value">{{ $stats->converted_sales }}</div>
                    <div class="stats-change">
                        <span class="conversion-badge conversion-high">
                            <i class="bi bi-arrow-up"></i> {{ $stats->conversion_rate }}%
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-value">{{ $stats->getFormattedCommissionsEarned() }}</div>
                    <div class="stats-change text-success">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <div class="stats-value">{{ $stats->team_size }}</div>
                    <div class="stats-change text-muted">
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <div class="stats-value">{{ $stats->getFormattedThisMonthCommissions() }}</div>
                    <div class="stats-change text-success">
            ...
            <div class="col-md-4">
                <div class="stats-card">
                    ...
                    <div class="stats-value">{{ $stats->getFormattedPendingCommissions() }}</div>
                    <div class="stats-change text-warning">
                        <i class="bi bi-clock"></i> {{ $stats->pending_referrals }} Referrals
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="text-center p-3">
                                ...
                                <div class="display-6 fw-bold text-success">{{ $stats->conversion_rate }}%</div>
                                <small class="text-muted">{{ $stats->converted_sales }}/{{ $stats->verified_referrals }} converted</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="text-center p-3">
                                <div class="text-muted mb-2">Verification Rate</div>
                                <div class="display-6 fw-bold text-info">{{ $stats->getVerificationRate() }}%</div>
                                <small class="text-muted">{{ $stats->verified_referrals }}/{{ $stats->total_referrals }} verified</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="text-center p-3">
                                <div class="text-muted mb-2">Avg. Commission/Sale</div>
                                <div class="display-6 fw-bold text-warning">₹{{ number_format($stats->getAverageCommissionPerSale(), 0) }}</div>
